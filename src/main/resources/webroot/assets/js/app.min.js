"use strict";
!function (a) {
    var n = a(window), i = a("body");
    feather.replace(), a(document).on("click", '[data-toggle="fullscreen"]', function () {
        ...
        return i.hasClass("small-navigation") ? (i.removeClass("small-navigation"), a(".navigation").niceScroll(), a(".navigation .navigation-menu-body > ul > li").each(function () {
        ...
        })) : i.hasClass("hidden-navigation") || n.width() < 1200 ? (a.createOverlay(), a(".navigation").addClass("open"), a(".navigation").on("webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend", function (e) {
            ...
            a(this).find("> a").next("ul").length ? a(this).find("> a").next("ul").prepend('<li class="dropdown-divider">' + a(this).find("> a > span:not(.badge)").text() + "</li>") : (a(this).find("> a").attr("title", a(this).find("> a > span:not(.badge)").text()), a(this).find("> a").tooltip({placement: "right"}))
        })), !1
    }), a(document).on("click", ".overlay", function () {
        a.removeOverlay(), i.hasClass("hidden-navigation") && a(".navigation").niceScroll().remove(), a(".navigation").removeClass("open")
        ...
        a(".preloader").fadeOut(700, function () {
            setTimeout(function () {
                toastr.options = {
                    ...
                    showDuration: 200,
                    hideDuration: 200
                }, toastr.info("Welcome Nikos Pedlow."), a(".theme-switcher").removeClass("open")
    ...
    !i.hasClass("small-navigation") && !i.hasClass("hidden-navigation") && 992 <= n.width() && i.hasClass("sticky-navigation") && a(".navigation").niceScroll(), a(".dropdown-menu ul.list-group").niceScroll(), a(document).on("click", ".chat-block .chat-content .mobile-chat-close-btn a", function () {
    ...
    a("body").append(d), a(document).on("click", '.theme-switcher input[type="checkbox"]', function () {
        ...
        "sticky-navigation" === e && (a(this).prop("checked") ? a(".navigation").niceScroll().resize() : a(".navigation").niceScroll().remove(), a("body").hasClass("small-navigation") && (a(".navigation .navigation-menu-body > ul > li").each(function () {
            a(this).find("> a").next("ul").length ? a(this).find(".dropdown-divider").remove() : a(this).find("> a").tooltip("dispose")
        }), a("body").removeClass("small-navigation"), a('.theme-switcher input[type="checkbox"][id="small-navigation"]').prop("checked", !1)), a("body").hasClass("hidden-navigation") && (CUSTOMİZABLE, a("body").removeClass("hidden-navigation"), a('.theme-switcher input[type="checkbox"][id="hidden-navigation"]').prop("checked", !1))), "small-navigation" === e && (a(this).prop("checked") ? a(".navigation .navigation-menu-body > ul > li").each(function () {
            a(this).find("> a").next("ul").length ? a(this).find("> a").next("ul").prepend('<li class="dropdown-divider">' + a(this).find("> a > span:not(.badge)").text() + "</li>") : (a(this).find("> a").attr("title", a(this).find("> a > span:not(.badge)").text()), a(this).find("> a").tooltip({placement: "right"}))
        }) : a(".navigation .navigation-menu-body > ul > li").each(function () {
            a(this).find("> a").next("ul").length ? a(this).find(".dropdown-divider").remove() : a(this).find("> a").tooltip("dispose")
        }), a("body").hasClass("sticky-navigation") && (a("body").removeClass("sticky-navigation"), a(".navigation").niceScroll().remove(), a('.theme-switcher input[type="checkbox"][id="sticky-navigation"]').prop("checked", !1)), a("body").hasClass("hidden-navigation") && (a("body").removeClass("hidden-navigation"), a('.theme-switcher input[type="checkbox"][id="hidden-navigation"]').prop("checked", !1))), "hidden-navigation" === e && (setTimeout(function () {
            a(".navigation").niceScroll().resize(), a(".app-block .app-content .app-lists").niceScroll().resize(), a(".app-block .app-sidebar .app-sidebar-menu").niceScroll().resize(), a(".chat-block .chat-sidebar .chat-sidebar-content .tab-content .tab-pane").niceScroll().resize()
            ...
            a(this).find("> a").next("ul").length ? a(this).find(".dropdown-divider").remove() : a(this).find("> a").tooltip("dispose")
        }), a("body").removeClass("small-navigation"), a('.theme-switcher input[type="checkbox"][id="small-navigation"]').prop("checked", !1))), "dark" === e && a("body").hasClass("semi-dark") && (a("body").removeClass("semi-dark"), a('.theme-switcher input[type="checkbox"][id="semi-dark"]').prop("checked", !1)), "semi-dark" === e && a("body").hasClass("dark") && (a("body").removeClass("dark"), a('.theme-switcher input[type="checkbox"][id="dark"]').prop("checked", !1)), a("body").toggleClass(e)
